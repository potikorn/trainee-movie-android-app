package com.example.potikorn.testcoopapp.genres.adapter
...
import com.example.potikorn.testcoopapp.movies.holder.MovieViewDetails


class AdapterGenres (private var movies: List<Movie>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
